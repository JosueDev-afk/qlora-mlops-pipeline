...
demo:      ## Streamlit demo of both flows
	streamlit run src/agent/demo.py
...
.PHONY: help up down clean logs init ingest curate localize generate augment gold train eval serve demo test test-all lint fmt

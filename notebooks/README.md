...
| `04_carrier_phrase_qa.ipynb` | Manual review of the carrier-phrase bank and template samples (naturalness gate) | 2 |
...
| `07_hypotheses.ipynb` | Figures and statistical tests for H1–H6 | 4 |
